...
public class DetailPackageDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btbBuyData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DetailPackageDataActivity.this, PaymentSuccessActivity.class);
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                Toast.makeText(DetailPackageDataActivity.this, "Số dư đã được cập nhật!", Toast.LENGTH_SHORT).show();
                                            } else {
                                                // Xử lý khi cập nhật không thành công
                                                Toast.makeText(DetailPackageDataActivity.this, "Lỗi khi cập nhật số dư: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                        } else {
                            // Hiển thị thông báo nếu số dư không đủ
                            Toast.makeText(DetailPackageDataActivity.this, "Số dư không đủ!", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        // Hiển thị thông báo nếu không tìm thấy người dùng
                        Toast.makeText(DetailPackageDataActivity.this, "Không tìm thấy người dùng!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // Hiển thị thông báo khi có lỗi truy cập dữ liệu
                    Toast.makeText(DetailPackageDataActivity.this, "Lỗi khi truy cập dữ liệu: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void updateNotification(String titletran, String pricetran, String date, String hour){
        ...
        db.collection("TransactionInfo").add(notificationMap)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(DetailPackageDataActivity.this, "Thông tin đã được đẩy lên Firebase", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(DetailPackageDataActivity.this, "Lỗi khi đẩy thông tin lên Firebase: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
}