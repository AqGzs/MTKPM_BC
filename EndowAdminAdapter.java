...
public class EndowAdminAdapter extends RecyclerView.Adapter<EndowAdminAdapter.UuDaiViewHolder> {
    private List<EndowModel> uuDaiList;
    private Context context;

    public EndowAdminAdapter(List<EndowModel> uuDaiList, Context context) {
    ...
    public void addUuDai(EndowModel newUuDai) {
    ...
    public void onBindViewHolder(@NonNull UuDaiViewHolder holder, int position) {
        EndowModel uuDai = uuDaiList.get(position);
    ...
    public void setData(List<EndowModel> uuDaiList) {
        this.uuDaiList = uuDaiList;
